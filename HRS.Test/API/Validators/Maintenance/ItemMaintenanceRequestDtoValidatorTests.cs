...
public class ItemMaintenanceRequestDtoValidatorTests
{
    ...
    {
        var model = new FixItemMaintenanceRequestDto { Id = "", QuantityFixed = 0, Remarks = new string('a', 501) };
    ...
    {
        var model = new FixItemMaintenanceRequestDto { Id = "1", QuantityFixed = 2, Remarks = "All good" };
        var result = _validator.TestValidate(model);
    ...
    {
        var model1 = new FixItemMaintenanceRequestDto { Id = "1", QuantityFixed = 2, Remarks = null };
        var model2 = new FixItemMaintenanceRequestDto { Id = "1", QuantityFixed = 2, Remarks = string.Empty };
